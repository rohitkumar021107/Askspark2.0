...
import { S as Subscribable, p as pendingThenable, k as resolveEnabled, n as shallowEqualObjects, o as resolveStaleTime, q as noop, t as environmentManager, v as isValidTimeout, w as timeUntilStale, x as timeoutManager, y as focusManager, z as fetchState, B as replaceData, C as notifyManager, D as hashKey, E as getDefaultState, r as reactExports, F as shouldThrowError, G as useQueryClient, g as getOrCreateUserId, l as loadLocalProfile, s as saveLocalProfile } from "./index-CiicjzrK.js";
import { s as submitDoubt } from "./useFirestoreDoubts-CPACqU8A.js";
...
function useSubmitDoubt() {
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async (input) => {
      const userId = getOrCreateUserId();
      const profile = loadLocalProfile();
      const studentName = (profile == null ? void 0 : profile.displayName) ?? "Anonymous";
